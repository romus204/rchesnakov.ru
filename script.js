...
const resumeContent = {
    ...
    ru: `
        ...
        <ul>
            ...
            <li><strong>Self-hosted</strong> — Являюсь сторонником self-hosted решений. Владею небольшой домашней инфраструктурой. Находюсь в процессе постройки кластера на базе SBC.</li>
        </ul>
